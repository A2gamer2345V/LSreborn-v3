package com.A2plugin.lsreborn.storage;

import org.bukkit.configuration.file.FileConfiguration;
import com.A2plugin.lsreborn.LSReborn;
import com.A2plugin.lsreborn.storage.connectionPool.ConnectionPool;
import com.A2plugin.lsreborn.storage.connectionPool.MariaDBConnectionPool;
...
public final class MariaDBStorage extends MySQLSyntaxStorage {
    ...
    public MariaDBStorage(LSReborn plugin) {
        super(plugin);
