package com.A2plugin.lsreborn.util.customitems;
...
public final class CustomItemManager {
    public static final NamespacedKey CUSTOM_ITEM_ID_KEY = new NamespacedKey(LSReborn.getInstance(), "customitemid");
    public static final NamespacedKey CUSTOM_ITEM_TYPE_KEY = new NamespacedKey(LSReborn.getInstance(), "customitemtype");
    public static final NamespacedKey CUSTOM_HEART_VALUE_KEY = new NamespacedKey(LSReborn.getInstance(), "customheartvalue");
    public static final NamespacedKey REVIVE_PAGE_KEY = new NamespacedKey(LSReborn.getInstance(), "revivepage");
    public static final NamespacedKey DESPAWNABLE_KEY = new NamespacedKey(LSReborn.getInstance(), "despawnable");
    public static final NamespacedKey INVULNERABLE_KEY = new NamespacedKey(LSReborn.getInstance(), "invulnerable");
    ...
    public static ItemStack createCustomItem(String itemId) {
        try {
            FileConfiguration config = LSReborn.getInstance().getConfigManager().getCustomItemConfig();
            ...
            CustomItem ci = new CustomItem(material)
                    ...
                    .setId("lsreborn_" + itemId, config.getInt(itemId + ".customModelId", 0))
            ...
            LSReborn.getInstance().getLogger().log(Level.SEVERE, "Could not create custom item with id '" + itemId + "': " + ex.getMessage(), ex);
    ...
    public static ItemStack createHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.default", "defaultheart"));
    }
    ...
    public static ItemStack createWithdrawHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.withdraw", "defaultheart"));
    }
    ...
    public static ItemStack createKillHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.kill", "defaultheart"));
    }
    ...
    public static ItemStack createNaturalDeathHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.naturalDeath", "defaultheart"));
    }
    ...
    public static ItemStack createHeartGainCooldownHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.heartGainCooldown", "defaultheart"));
    }
    ...
    public static ItemStack createMaxHealthHeart() {
        return createCustomItem(LSReborn.getInstance().getConfig().getString("heartItem.maxHearts", "defaultheart"));
    }
    ...
    public static ItemStack createCloseItem() {
        ...
        ci.getItemStack().setData(
                ...
                CustomModelData.customModelData().addString("lsreborn_close").build()
        );
    ...
    public static ItemStack createBackItem(int page) {
        ...
        ci.getItemStack().setData(
                DataComponentTypes.CUSTOM_MODEL_DATA,
                CustomModelData.customModelData().addString("lsreborn_back").build()
        );
    ...
    public static ItemStack createNextItem(int page) {
        ...
        ci.getItemStack().setData(
                DataComponentTypes.CUSTOM_MODEL_DATA,
                CustomModelData.customModelData().addString("lsreborn_next").build()
        );
    ...
    public static ItemStack createHeartAnimationTotem() {
        ...
        ci.getItemStack().setData(
                DataComponentTypes.CUSTOM_MODEL_DATA,
                CustomModelData.customModelData().addString("lsreborn_totem").build()
        );
    ...
    public static ItemStack getBedrockPlayerHead(UUID uuid) {
        ...
        skullMeta.displayName(Component.text("§d" + LSReborn.getInstance().getGeyserManager().getOfflineBedrockPlayerName(uuid)));
