...
import com.A2plugin.lsreborn.addon.LSRebornAddon;
...
public final class ConfigManager {
    ...
    public ConfigManager(LSReborn plugin) {
        this.plugin = plugin;
    }
    ...
    public FileConfiguration getAddonConfig(LSRebornAddon addon) {
    ...
    public FileConfiguration getAddonConfig(String configName, Class<? extends LSRebornAddon> addonClass) {
