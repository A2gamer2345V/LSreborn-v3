package com.A2plugin.lsreborn.util.customblocks;
...
public enum CustomBlock {
    ...
    private final static NamespacedKey CUSTOM_BLOCK_KEY = new NamespacedKey("lsreborn", "custom_block");
    private final static NamespacedKey CUSTOM_ITEM_ID_KEY = new NamespacedKey("lsreborn", "custom_item_id_block");
