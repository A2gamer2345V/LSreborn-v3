...
public final class LanguageManager {
    ...
    public static final List<String> defaultLangs = List.of("cs-CZ", "de-DE", "en-US", "es-ES", "fr-FR", "pl-PL", "vi-VN", "zh-CN", "nl-NL", "ru-RU", "pt-BR", "ja-JP", "hu-HU", "it-IT", "tr-TR");

    private FileConfiguration langConfig;

    public LanguageManager(LSReborn plugin) {
        this.plugin = plugin;
        loadLanguageConfig();
    }
