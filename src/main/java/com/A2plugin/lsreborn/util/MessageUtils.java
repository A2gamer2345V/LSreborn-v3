...
public final class MessageUtils {
    ...
    public static Component getAndFormatMsg(boolean addPrefix, String path, String fallback, Replaceable... replaceables) {
        ...
        MiniMessage mm = MiniMessage.miniMessage();
        String msg = "<!i>" + LSReborn.getInstance().getLanguageManager().getString(path, fallback);
        String prefix = LSReborn.getInstance().getLanguageManager().getString("prefix", "&8[&clsreborn&8]");
