...
/**
 * VersionChecker is a utility class that checks for updates of the lsreborn plugin
...
public final class VersionChecker {
    ...
    public VersionChecker(LSReborn plugin, String modrinthProjectId) {
        this.plugin = plugin;
    ...
    /**
     * Checks for updates of the lsreborn plugin by comparing the current version with the latest version available on Modrinth.
    ...
    private void checkForUpdates() {
        ...
        if (latestVersion != null) {
            ...
            if (!latestVersion.trim().equals(currentVersion.trim())) {
                ...
                String message = "\n" +
                        darkGray + "==========================================" + reset + "\n" +
                        bold + "A new version of lsreborn is available!" + reset + "\n" +
                        bold + "New Version: " + reset + bold + red + latestVersion + reset + lightGray + " (Your version: " + currentVersion + ")" + reset + "\n" +
                        bold + "Download here: " + reset + lightGray + reset + "https://modrinth.com/plugin/lsreborn/version/" + latestVersion + "\n" +
                        darkGray + "==========================================" + reset;
