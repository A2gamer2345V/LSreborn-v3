...
import static com.A2plugin.lsreborn.util.commands.CommandUtils.parsePlayerName;
...
public final class GiveItemSubCommand implements SubCommand {
    ...
    public GiveItemSubCommand(LSReborn plugin) {
        this.plugin = plugin;
    }
    ...
    public String getUsage() {
        return "/lsreborn giveItem <player> <item> [amount]";
    }

    @Override
    public boolean hasPermission(CommandSender sender) {
        return sender.hasPermission("lsreborn.admin.giveitem");
    }
}
