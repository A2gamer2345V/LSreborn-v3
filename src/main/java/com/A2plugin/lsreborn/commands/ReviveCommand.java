package com.A2plugin.lsreborn.commands;
...
public final class ReviveCommand implements CommandExecutor, TabCompleter {
    ...
    public ReviveCommand(LSReborn plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean handleReviveAll(CommandSender sender, String bypassOption) {
        try {
            int revivedPlayers = plugin.getStorage().reviveAllPlayers(
                    ...
                    BYPASS_OPTION.equals(bypassOption) && sender.hasPermission("lsreborn.bypassrevivelimit")
            );
    ...
    private boolean canRevive(CommandSender sender, PlayerData playerData, String bypassOption) {
        ...
        boolean hasBypassPermission = sender.hasPermission("lsreborn.bypassrevivelimit");
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, String[] args) {
        ...
        if (args.length == 2 && sender.hasPermission("lsreborn.bypassrevivelimit")) {
