![LSReborn Banner](https://github.com/A2gamer2345V/LSReborn/blob/main/img%20(2).png?raw=true)

---

![paper](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/supported/paper_vector.svg)
![purpur](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/supported/purpur_vector.svg)
[![github](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/available/github_vector.svg)](https://github.com/A2gamer2345V/LSReborn)
[![modrinth](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/available/modrinth_vector.svg)](https://modrinth.com/project/fjE4HIKE)
[![hangar](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/available/hangar_vector.svg)](https://hangar.papermc.io/A2gamer/LSReborn#-lsreborn)
[![discord-plural](https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/compact/social/discord-plural_vector.svg)](https://discord.gg/pAAmuNPUrJ)

LSReborn is a lifesteal SMP plugin, that allows you to steal hearts from other players, when you kill them. If a player has no more hearts, he is eliminated. You can craft additional hearts or a revive crystal. With this crystal, you can bring back eliminated teammates.

LSReborn offers a great amount of admin tools and is highly customizable. You can change every message and change everything about the custom items.

<br>

---

![FeaturesBanner](https://github.com/A2gamer2345V/LSReborn/blob/main/features.png?raw=true)
...
![PermissionsBanner](https://github.com/A2gamer2345V/LSReborn/blob/main/permissions.png?raw=true)

- **LSReborn.admin.reload** - Allow to reload the plugin
- **LSReborn.admin.setlife** - Allow to set the amount of hearts, a player has
- **LSReborn.admin.giveitem** - Allow to give custom items to a player
- **LSReborn.admin.eliminate** - Allows to eliminate players with the `/eliminate` command
- **LSReborn.admin.revive** - Allow a player to revive another player with the `/revive` command
- **LSReborn.bypassrevivelimit** - Allow a player to bypass the revive limit
- **LSReborn.bypass** - Prevent heart loss/drops/rewards on death (default: false)
- **LSReborn.bypass.check** - Check bypass status for yourself and other players (default: op)
- **LSReborn.withdraw** - Allow a player to withdraw hearts (true by default)
- **LSReborn.revive** - Allow a player to revive others with a revive crystal (true by default)
- **LSReborn.viewrecipes** - Allow a player to view the custom recipes (true by default)
- **LSReborn.help** - Allow a player to access the help menu (true by default)
- **LSReborn.viewhearts** - Allow a player to view the amount of hearts (`/hearts`) he has (true by default)
- **LSReborn.maxhearts.[amount]** - Set the max hearts for a player. This overwrites the maxHearts in the config

<br>

---

![ConfigBanner](https://github.com/A2gamer2345V/LSReborn/blob/main/configuration.png?raw=true)

The conifuration is split into multiple files located at `plugins/LSReborn/`:

<details>
<summary>config.yml</summary>

```yml
#      __   _____    ____  __________  ____  ____  _   __
#     / /  / ___/   / __ \/ ____/ __ )/ __ \/ __ \/ | / /
#    / /   \__ \   / /_/ / __/ / __  / / / / /_/ /  |/ /
#   / /______/ /  / _, _/ /___/ /_/ / /_/ / _, _/ /|  /
#  /_____/____/  /_/ |_/_____/_____/\____/_/ |_/_/ |_/
...
# If set to true, LSReborn will check for updates and let you know if there's a newer version
...
# You can also set a per player limit using the LSReborn.maxhearts.[amount] permission or a per item limit in the items.yml file
maxHearts: 20
...
minHearts: 0
# This option will enforce the heart limit on admin commands like /LSReborn hearts <add, set> <player> <amount>
# Note that this
...
# The bypass permission is "LSReborn.bypass" and is not granted by default, even not to ops.
bypassPermission:
...
defaultheart: # <- This is the item id that can be used in recipes and for permissions
  ...
  # When using Minecraft 1.21.4 or newer, items also have a "minecraft:custom_model_data" property of "LSReborn_{itemId}"
  customModelId: 0
  ...
  # If this item requires a permission to be used (LSReborn.item.defaultheart)
...
revive:
  ...
  requirePermission: false # (LSReborn.item.revive)
  craftable: true
  recipes:
    1:
      rowOne:
...
![PlaceholderBanner](https://github.com/A2gamer2345V/LSReborn/blob/main/Placeholder.png?raw=true)
...
- **%LSReborn_hearts%** - The amount of hearts a user has
- **%LSReborn_maxhearts%** - The maximum amount of hearts a user can have
- **%LSReborn_health%** - The current health, that the player has (half hearts rounded up)
- **%LSReborn_revived%** - The amount of times a player has been revived
- **%LSReborn_isInGracePeriod%** - If the player is in the grace period
- **%LSReborn_gracePeriodRemaining%** - The remaining time of the grace period in seconds

<br>

---

![supportBanner](https://github.com/A2gamer2345V/LSReborn/blob/main/support.png?raw=true)

If you need help with the setup of the plugin, or found a bug, you can join my discord [here](https://discord.gg/pAAmuNPUrJ).
